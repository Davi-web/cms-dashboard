...
import { Users, Building2, CheckSquare, BarChart3, Settings, LogOut, User } from 'lucide-react'
...
function AppContent() {
  ...
  useEffect(() => {
    if (user && (localContacts.length > 0 || localCompanies.length > 0 || localTasks.length > 0)) {
        ...
        return (
          <div className="p-6">
            ...
            <div className="mt-6 space-y-4">
              ...
              {(localContacts.length > 0 || localCompanies.length > 0 || localTasks.length > 0) && (
                <div className="p-4 border rounded-lg">
